...
export function PdfPageHeader({
  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 mb-4 border-b-2 border-primary/20 bg-gradient-to-r from-primary/5 to-transparent rounded-t-lg">
      {/* Left: Logo + Studio */}
      <div className="flex items-center gap-2">
        ...
        {studioName && (
          <span className="font-semibold text-foreground text-xs">{studioName}</span>
        )}
      </div>
