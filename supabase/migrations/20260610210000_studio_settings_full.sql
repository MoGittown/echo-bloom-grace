-- Vollständige Studio-Konfiguration (Web + App, ein Tenant pro Zeile)
...
CREATE UNIQUE INDEX IF NOT EXISTS studio_branding_studio_code_idx
  ON public.studio_branding (studio_code)
  WHERE studio_code IS NOT NULL AND studio_code <> '';
