...
-- Behebt: Admin „Einrichten“ schlägt fehl, obwohl Studio schon existiert.

-- 1) Fehlende Spalten (falls Migrationen noch nicht gelaufen)
...
-- 2) Public-View: security_invoker OFF, damit anon die Zeilen sieht
